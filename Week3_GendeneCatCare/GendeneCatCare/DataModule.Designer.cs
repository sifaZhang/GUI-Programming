namespace GendeneCatCare
{
    ...
    "ER BY CatID";
            ...
            // ctnGlendene
            // 
            this.ctnGlendene.ConnectionString = "Provider=Microsoft.ACE.OLEDB.16.0;Data Source=C:\\Temp\\Glendene.mdb";
            // 
            // oleDbInsertCommand1
            // 
    ...
    "`) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            // oleDbSelectCommand2
            // 
            this.oleDbSelectCommand2.CommandText = "SELECT VETERINARIAN.*\r\nFROM  VETERINARIAN\r\nORDER BY VeterinarianID";
            this.oleDbSelectCommand2.Connection = this.ctnGlendene;
            // 
            // oleDbInsertCommand2
            // 
            this.oleDbInsertCommand2.CommandText = "INSERT INTO `VETERINARIAN` (`LastName`, `FirstName`, `Rate`) VALUES (?, ?, ?)";
            ...
            // daVeterinarian
            // 
            this.daVeterinarian.DeleteCommand = this.oleDbDeleteCommand2;
            this.daVeterinarian.InsertCommand = this.oleDbInsertCommand2;
            this.daVeterinarian.SelectCommand = this.oleDbSelectCommand2;
            ...
            this.daVeterinarian.UpdateCommand = this.oleDbUpdateCommand2;
            // 
            // oleDbSelectCommand3
            // 
    ...
    "(? = 1 AND `Quantity` IS NULL) OR (`Quantity` = ?)))";
        ...
        public System.Data.OleDb.OleDbConnection ctnGlendene;
